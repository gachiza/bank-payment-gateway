...
import { createAccountSchema, accountDetailsSchema, depositSchema} from "../services/account.services"
...
router.get("/:accountId", authMiddleware.authenticate, validate(accountDetailsSchema), AccountController.getAccountDetails);
